  ...
  function calcularNutricion (usuario) {
    if (usuario != null) {
      ...
      switch (meta) {
        case 'Lose_Fat':
          return {
            proteins: [Recipes.breakfast.proteins[0], Recipes.lunch.proteins[0], Recipes.dinner.proteins[0]],
        ...
        case 'Keep_Fat':
          return {
            proteins: [Recipes.breakfast.proteins[1], Recipes.lunch.proteins[1], Recipes.dinner.proteins[1]],
        ...
        case 'Gain_Fat':
          return {
            proteins: [Recipes.breakfast.proteins[2], Recipes.lunch.proteins[2], Recipes.dinner.proteins[2]],
    ...
    switch (tipoComida) {
      case 'breakfast':
        ...
        if (comidas.breakfast.ingredients === null) {
          setProgress({
            proteins: progress.proteins + nut.proteins[0],
      ...
      case 'lunch':
        ...
        if (comidas.lunch.ingredients === null) {
          setProgress({
            proteins: progress.proteins + nut.proteins[1],
      ...
      case 'dinner':
        ...
        if (comidas.dinner.ingredients === null) {
          setProgress({
            proteins: progress.proteins + nut.proteins[2],
